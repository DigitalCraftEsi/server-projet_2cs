...
-- AlterTable
ALTER TABLE `ac` MODIFY `picture` VARCHAR(200) NULL;

-- AlterTable
ALTER TABLE `adm` MODIFY `picture` VARCHAR(200) NULL;

-- AlterTable
ALTER TABLE `am` MODIFY `picture` VARCHAR(200) NULL;

-- AlterTable
ALTER TABLE `consommateur` MODIFY `picture` VARCHAR(200) NULL;

-- AlterTable
ALTER TABLE `decideur` MODIFY `picture` VARCHAR(200) NULL;

-- AlterTable
ALTER TABLE `sadm` MODIFY `picture` VARCHAR(200) NULL;
