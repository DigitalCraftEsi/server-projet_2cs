...
-- DropIndex
DROP INDEX `idTache` ON `anomalie`;
...
-- DropIndex
DROP INDEX `idTache` ON `panne`;

-- AlterTable
ALTER TABLE `consommateur` ADD COLUMN `picture` VARCHAR(200) NULL;

-- AlterTable
ALTER TABLE `panne` ADD COLUMN `qte` INTEGER NULL;

-- AlterTable
ALTER TABLE `tache` ADD COLUMN `type` VARCHAR(50) NULL;
