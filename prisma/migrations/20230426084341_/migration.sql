/*
  ...
  - Added the required column `picture` to the `ac` table without a default value. This is not possible if the table is not empty.
  - Added the required column `picture` to the `adm` table without a default value. This is not possible if the table is not empty.
  - Added the required column `picture` to the `am` table without a default value. This is not possible if the table is not empty.
  - Added the required column `picture` to the `consommateur` table without a default value. This is not possible if the table is not empty.
  - Added the required column `picture` to the `decideur` table without a default value. This is not possible if the table is not empty.
  - Added the required column `picture` to the `sadm` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `ac` ADD COLUMN `picture` VARCHAR(200) NOT NULL;

-- AlterTable
ALTER TABLE `adm` ADD COLUMN `picture` VARCHAR(200) NOT NULL;

-- AlterTable
ALTER TABLE `am` ADD COLUMN `picture` VARCHAR(200) NOT NULL;

-- AlterTable
ALTER TABLE `consommateur` ADD COLUMN `picture` VARCHAR(200) NOT NULL;

-- AlterTable
ALTER TABLE `decideur` ADD COLUMN `picture` VARCHAR(200) NOT NULL;

-- AlterTable
ALTER TABLE `sadm` ADD COLUMN `picture` VARCHAR(200) NOT NULL;
